...
//bm.bnq
var bnq = function(iN, HG) {
    var iS = {};
    cv((iN || "").split(HG), function(bX) {
        var Rw = bX.split("=");
        if (!Rw || !Rw.length)
            return;
        var bN = Rw.shift();
...
var Aa = function(bl, bu) {
    try {
        ...
        if (bl === undefined)
            return bu == "undefined";
        return NEJ.O.toString.call(bl).toLowerCase() == "[object " + bu + "]"
    } catch (e) {
        return !1
    }
};
// bm.cv 
var cv = function(bk, gP, rD) {
    if (!bk || !bk.length || !hC(gP))
        return this;
    if (!!bk.forEach) {
        bk.forEach(gP, rD);
        return this
